...
class Plot:
    ...
    def style(self, s):
        if s == 'jma':
            ...
            self.m.drawmapboundary(fill_color='#CBCBCB', ax=self.ax)
            self.m.fillcontinents(color='#A0522E', lake_color='#CBCBCB')
            self.linecolor.update(dict(coastline='k', country='k',
                                       parameri='k',province='k', city='k'))
        elif s == 'blackBGRadar':
            self.m.drawmapboundary(fill_color='#000000')
            self.m.fillcontinents(color='#000000', lake_color='#000000')
            self.linecolor.update(dict(coastline='w', country='w',
